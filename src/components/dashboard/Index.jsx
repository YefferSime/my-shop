...
const Index = () => {
    ...
    // Traducción de estados al español con colores
    const statusMap = {
        pending: 'Pendiente',
    ...
    return (
        <div>
            ...
            <div className="bg-white p-4 mt-5 rounded-md">
                <h2 className="text-lg font-semibold text-slate-600">Órdenes Recientes</h2>
                <div className="pt-4">
                                    ...
                                    <tr key={i} className="bg-white border-b">
                                        ...
                                        <td scope="row" className="px-6 py-4">
                                            ...
                                            {o.payment_status !== 'paid' && (
                                                <span
                                                    onClick={() => redirect(o)}
                                                    className="bg-yellow-100 text-yellow-800 text-sm font-normal mr-2 px-2.5 py-[1px] rounded cursor-pointer"
                                                >
                                                    Pagar Ahora
                                                </span>
                                            )}
