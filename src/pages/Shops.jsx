...
const Shops = () => {
    ...
    return (
        <div>
            <Headers />
            <section className='bg-[url("https://my-shop-navy.vercel.app/images/banner/baner.jpg")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
                    ...
                    <div className='w-full flex flex-wrap'>
                        <div className={`w-3/12 md-lg:w-4/12 md:w-full pr-8 ${filter ? 'md:h-0 md:overflow-hidden md:mb-6' : 'md:h-auto md:overflow-auto md:mb-0'}`}>
                            ...
                            <div className='py-2 flex flex-col gap-5'>
                                ...
                                />
                                <div>
                                    <span className='text-red-500 font-bold text-lg'>S/{Math.floor(state.values[0])} - S/{Math.floor(state.values[1])}</span>
                                </div>
                            </div>
