                    ...
                    <div className='grid grid-cols-2 w-[60%] mx-auto bg-white rounded-md'>
                        <div className='px-8 py-8'>
                            ...
                            <div>
                                <form onSubmit={register} className='text-slate-600'>
                                    <div className='flex flex-col gap-1 mb-2'>
                                        ...
                                        <input onChange={inputHandle} value={state.name} type="text" className='w-full px-3 py-2 border border-slate-200 outline-none focus:border-indigo-500 rounded-md' id='name' name='name' placeholder='Nombre' required />
                                    </div>
                                    <div className='flex flex-col gap-1 mb-2'>
                                    ...
                                    <div className='flex flex-col gap-1 mb-4'>
                                        ...
                                        <input onChange={inputHandle} value={state.password} type="password" className='w-full px-3 py-2 border border-slate-200 outline-none focus:border-indigo-500 rounded-md' id='password' name='password' placeholder='Contraseña' required />
                                    </div>
                                    <button className='px-8 w-full py-2 bg-purple-500 shadow-lg hover:shadow-indigo-500/30 text-white rounded-md'>Registrarse</button>
                                </form>
                            ...
                            <div className='text-center text-slate-600 pt-1'>
                                <p>¿Ya tienes una cuenta? <Link className='text-blue-500' to='/login'>¡Inicia sesión!</Link></p>
                            </div>
                            <div className='text-center text-slate-600 pt-1'>
                                <p> <a target='_black' className='text-blue-500' href='http://localhost:3001/login'>¡Inicia sesión</a> como vendedor!</p>
                            </div>
                        </div>
